...
var r = s(function(e, t2) {
  ...
  e.exports = (n2 = i, function(e2) {
    ...
    var c2 = o2.MD5 = i2.extend({ _doReset: function() {
      ...
      var i3 = this._hash.words, o3 = e3[t4 + 0], c3 = e3[t4 + 1], p2 = e3[t4 + 2], f2 = e3[t4 + 3], g2 = e3[t4 + 4], m2 = e3[t4 + 5], y2 = e3[t4 + 6], _2 = e3[t4 + 7], w2 = e3[t4 + 8], v2 = e3[t4 + 9], I2 = e3[t4 + 10], S2 = e3[t4 + 11], b2 = e3[t4 + 12], k2 = e3[t4 + 13], C = e3[t4 + 14], T2 = e3[t4 + 15], P2 = i3[0], A = i3[1], E2 = i3[2], O = i3[3];
      P2 = u2(P2, A, E2, O, o3, 7, a2[0]), O = u2(O, P2, A, E2, c3, 12, a2[1]), E2 = u2(E2, O, P2, A, p2, 17, a2[2]), A = u2(A, E2, O, P2, f2, 22, a2[3]), P2 = u2(P2, A, E2, O, g2, 7, a2[4]), O = u2(O, P2, A, E2, m2, 12, a2[5]), E2 = u2(E2, O, P2, A, y2, 17, a2[6]), A = u2(A, E2, O, P2, _2, 22, a2[7]), P2 = u2(P2, A, E2, O, w2, 7, a2[8]), O = u2(O, P2, A, E2, v2, 12, a2[9]), E2 = u2(E2, O, P2, A, I2, 17, a2[10]), A = u2(A, E2, O, P2, S2, 22, a2[11]), P2 = u2(P2, A, E2, O, b2, 7, a2[12]), O = u2(O, P2, A, E2, k2, 12, a2[13]), E2 = u2(E2, O, P2, A, C, 17, a2[14]), P2 = h2(P2, A = u2(A, E2, O, P2, T2, 22, a2[15]), E2, O, c3, 5, a2[16]), O = h2(O, P2, A, E2, y2, 9, a2[17]), E2 = h2(E2, O, P2, A, S2, 14, a2[18]), A = h2(A, E2, O, P2, o3, 20, a2[19]), P2 = h2(P2, A, E2, O, m2, 5, a2[20]), O = h2(O, P2, A, E2, I2, 9, a2[21]), E2 = h2(E2, O, P2, A, T2, 14, a2[22]), A = h2(A, E2, O, P2, g2, 20, a2[23]), P2 = h2(P2, A, E2, O, v2, 5, a2[24]), O = h2(O, P2, A, E2, C, 9, a2[25]), E2 = h2(E2, O, P2, A, f2, 14, a2[26]), A = h2(A, E2, O, P2, w2, 20, a2[27]), P2 = h2(P2, A, E2, O, k2, 5, a2[28]), O = h2(O, P2, A, E2, p2, 9, a2[29]), E2 = h2(E2, O, P2, A, _2, 14, a2[30]), P2 = l2(P2, A = h2(A, E2, O, P2, b2, 20, a2[31]), E2, O, m2, 4, a2[32]), O = l2(O, P2, A, E2, w2, 11, a2[33]), E2 = l2(E2, O, P2, A, S2, 16, a2[34]), A = l2(A, E2, O, P2, C, 23, a2[35]), P2 = l2(P2, A, E2, O, c3, 4, a2[36]), O = l2(O, P2, A, E2, g2, 11, a2[37]), E2 = l2(E2, O, P2, A, _2, 16, a2[38]), A = l2(A, E2, O, P2, I2, 23, a2[39]), P2 = l2(P2, A, E2, O, k2, 4, a2[40]), O = l2(O, P2, A, E2, o3, 11, a2[41]), E2 = l2(E2, O, P2, A, f2, 16, a2[42]), A = l2(A, E2, O, P2, y2, 23, a2[43]), P2 = l2(P2, A, E2, O, v2, 4, a2[44]), O = l2(O, P2, A, E2, b2, 11, a2[45]), E2 = l2(E2, O, P2, A, T2, 16, a2[46]), P2 = d2(P2, A = l2(A, E2, O, P2, p2, 23, a2[47]), E2, O, o3, 6, a2[48]), O = d2(O, P2, A, E2, _2, 10, a2[49]), E2 = d2(E2, O, P2, A, C, 15, a2[50]), A = d2(A, E2, O, P2, m2, 21, a2[51]), P2 = d2(P2, A, E2, O, b2, 6, a2[52]), O = d2(O, P2, A, E2, f2, 10, a2[53]), E2 = d2(E2, O, P2, A, I2, 15, a2[54]), A = d2(A, E2, O, P2, c3, 21, a2[55]), P2 = d2(P2, A, E2, O, w2, 6, a2[56]), O = d2(O, P2, A, E2, T2, 10, a2[57]), E2 = d2(E2, O, P2, A, y2, 15, a2[58]), A = d2(A, E2, O, P2, k2, 21, a2[59]), P2 = d2(P2, A, E2, O, g2, 6, a2[60]), O = d2(O, P2, A, E2, S2, 10, a2[61]), E2 = d2(E2, O, P2, A, p2, 15, a2[62]), A = d2(A, E2, O, P2, v2, 21, a2[63]), i3[0] = i3[0] + P2 | 0, i3[1] = i3[1] + A | 0, i3[2] = i3[2] + E2 | 0, i3[3] = i3[3] + O | 0;
...
const b = false, k = "app", T = S([]), P = k;
S("");
const E = S('[{"provider":"aliyun","spaceName":"yx-plane","spaceId":"mp-2a0e68a1-4e42-4285-b25e-1462368efa7f","clientSecret":"Qi8TgmxnDRXiSeLDWh1xTQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__81D3AC3";
} catch (e) {
...
function Rn(e) {
  ...
  e.callFunction = function(t3) {
    ...
    let o2, a2;
    if (t3.data = t3.data || {}, o2 = n2, o2 = o2.bind(e), En(t3))
      a2 = n2.call(e, t3);
    else if (An(t3)) {
...
let Ns = new class {
  init(e) {
    ...
    t2 = n2.init(e), Us(t2), Rn(t2), function(e2) {
...
const __easycom_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$5], ["styles", [_style_0$4]]]);
...
const __easycom_1$1 = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$4], ["styles", [_style_0$3]]]);
...
const __easycom_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render$3], ["styles", [_style_0$2]]]);
...
const __easycom_1 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$2], ["styles", [_style_0$1]]]);
const en = {
...
const _style_0 = { "m-auto": { "": { "marginTop": 50, "marginBottom": 50, "textAlign": "center" } }, "s-25": { "": { "fontSize": 25 } } };
Ds.database();
const _sfc_main = {
  data() {
    return {
      ...
      createVNode(_component_unicloud_db, {
        ...
        default: withCtx(({ data, loading, error, options }) => [
          error ? (openBlock(), createElementBlock("view", {
            ...
            createElementVNode("u-text", null, toDisplayString(error.message), 1)
          ])) : loading ? (openBlock(), createElementBlock("view", {
            key: 1,
            ref: "loading",
            class: "loading"
          }, null, 512)) : (openBlock(), createElementBlock("view", { key: 2 }, [
            createVNode(_component_uni_list, null, {
              default: withCtx(() => [
                (openBlock(true), createElementBlock(Fragment, null, renderList(data, (item, i2) => {
